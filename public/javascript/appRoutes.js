...
angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives', 'ui']).
    ...
    $routeProvider.when('/', {templateUrl: '/partials/designSelector.html', controller: DesignSelectorController});
    $routeProvider.when('/:rangeId', {templateUrl: '/partials/designer.html', controller: DesignerController});
    $routeProvider.when('/ranges', {templateUrl: '/partials/ranges.html', controller: RangesController});
    $routeProvider.when('/ranges/:rangeId', {templateUrl: '/partials/rangeDetails.html', controller: RangesController});
